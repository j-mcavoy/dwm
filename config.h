...
static const Rule rules[] = {
    ...
    { "gPodder",     NULL,       NULL,           1 << 3,       0,           0,          0,        -1 },
    { "cura",        NULL,       NULL,           1 << 5,       0,           0,          0,        -1 },
    { "Discord",     NULL,       NULL,           1 << 8,       0,           0,          0,        -1 },
    { "St",          NULL,       NULL,           0,            0,           1,          0,        -1 },
    { "newsboat",    NULL,       NULL,           1 << 3,       0,           1,          0,        -1 },
    { "podboat -a",  NULL,       NULL,           1 << 3,       0,           1,          0,        -1 },
...
{ MODKEY|ShiftMask,    XK_v,    spawn,    SHCMD("st -e mpv ~/vids") },
...
{ MODKEY,      XK_F7,    spawn,    SHCMD("piactl connect") },
{ MODKEY,      XK_F8,    spawn,    SHCMD("piactl disconnect") },
{ MODKEY,      XK_F9,    spawn,    SHCMD("dmenumount") },
{ MODKEY,      XK_F10,    spawn,    SHCMD("dmenuumount") },
{ MODKEY,      XK_F11,    spawn,    SHCMD("mpv --no-cache --no-osc --no-input-default-bindings --input-conf=/dev/null --title=webcam $(ls /dev/video[0,2,4,6,8] | tail -n 1)") },
{ MODKEY,      XK_F12,    spawn,    {.v = NULL } },
...
{ 0, XF86XK_Mail,    spawn,    SHCMD("st -e neomutt ; kill -RTMIN+12 dwmblocks") },
